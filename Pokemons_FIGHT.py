...
# Definindo a classe pokemon que oferece as propriedades de cada pokemon ofertado
class pokemon:
...
#Definindo uma classe para os attacks
class Attack:
...
Leech_Seed = Attack("Leech_Seed", 0, 10, "Grass","Special")

Growl = Attack("Growl", 0, 25, "Normal", "Status")

Vine_Whip = Attack("Vine Whip", 45, 25, "Grass", "Physical")

Ember = Attack("Ember", 40, 25, "Fire", "Special")
...
Withdraw = Attack("Withdraw", 0, 40, "Water", "Status")
...
N = 48
Flail = Attack("Flail", N, 15, "Normal", "Physical") # N = (48 × CurrentHP ÷ MaxHP)
...
Revenge = Attack("Revenge ", 60, 10, "Fighting", "Physical")

Fake_Out = Attack("Fake Out", 90, 10, "Normal", "Physical")

Dano = 40
Reversal = Attack("Reversal", Dano, 15, "fighting", "Physical") # causa um maior dano quanto menor a sua vida
...
Pikachu = pokemon("Pikachu", Quick_Attack, Thunder_Shock, Growl, Thunder_Wave, "Electric", 160, 15, 45, 25)
...
def Special(attack, Pokemon2, Pokemon1,HP0):
...
def fight_1P(Pokemon1,Pokemon2):
    ...
    while Pokemon1.HP > 0 and Pokemon2.HP > 0:
        ...
        if Pokemon1.speed >= Pokemon2.speed or Attack1 == Quick_Attack:
            info1 = Special(Attack1, Pokemon2, Pokemon1, HP2)
            ...
            info2 = Special(Attack2, Pokemon1, Pokemon2, HP1)
...
def fight_2P(Pokemon1,Pokemon2):
    HP1 = Pokemon1.HP
    HP2 = Pokemon2.HP
    cursed = []
    Leech_Seed_Damage = 0
